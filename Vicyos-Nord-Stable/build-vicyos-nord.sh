...
sed -i "s/iso_name=/iso_name=vicyos-nord/g" work/archiso/build.sh
sed -i "s/iso_label=/iso_label="vicyos-nord-$(date +%Y.%m.%d)"/g" work/archiso/build.sh
sed -i "s/iso_publisher="'""'"/iso_publisher="'"vicyos-Nord <https:\/\/github.com\/felipendc>"'"/g" work/archiso/build.sh
sed -i "s/iso_application="'""'"/iso_application="'"vicyos-nord Live\/Rescue CD"'"/g" work/archiso/build.sh
sed -i "s/iso_version=/iso_version="$(date +%Y.%m.%d)"/g" work/archiso/build.sh

# Add the build date to the "DISTRIB_RELEASE"
release=$(date +%Y.%m.%d)
sed -i "s/DISTRIB_ID=VicyosLinux/DISTRIB_ID=Vicyos-Nord-Edition-$release/g" work/archiso/airootfs/etc/vicyos-release
...
sed -i "s/ISO_CODENAME=VicyosLinux/ISO_CODENAME=Vicyos-Nord-Edition-$release/g" work/archiso/airootfs/etc/dev-rel
