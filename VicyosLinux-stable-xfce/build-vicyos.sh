...
release=$(date +%Y.%m.%d)
sed -i "s/DISTRIB_ID=VicyosLinux/DISTRIB_ID=VicyosLinux-$release/g" work/archiso/airootfs/etc/vicyos-release
...
sed -i "s/ISO_CODENAME=VicyosLinux/ISO_CODENAME=VicyosLinux-$release/g" work/archiso/airootfs/etc/dev-rel
