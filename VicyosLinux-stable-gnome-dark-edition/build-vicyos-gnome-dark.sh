...
sed -i "s/iso_name=/iso_name=vicyos-gnome-dark/g" work/archiso/build.sh
sed -i "s/iso_label=/iso_label="vicyos-gnome-dark-$(date +%Y.%m.%d)"/g" work/archiso/build.sh
sed -i "s/iso_publisher="'""'"/iso_publisher="'"vicyos-gnome-dark <https:\/\/github.com\/felipendc>"'"/g" work/archiso/build.sh
sed -i "s/iso_application="'""'"/iso_application="'"vicyos-gnome-dark Live\/Rescue CD"'"/g" work/archiso/build.sh
sed -i "s/iso_version=/iso_version="$(date +%Y.%m.%d)"/g" work/archiso/build.sh

# Add the build date to the "DISTRIB_RELEASE"
release=$(date +%Y.%m.%d)
sed -i "s/DISTRIB_ID=VicyosLinux/DISTRIB_ID=Vicyos-Gnome-Dark-Edition-$release/g" work/archiso/airootfs/etc/vicyos-release
...
sed -i "s/ISO_CODENAME=VicyosLinux/ISO_CODENAME=Vicyos-Gnome-Dark-Edition-$release/g" work/archiso/airootfs/etc/dev-rel
